...
export const LISTENING_PRIORITIES = [
  ...
  { id: 'LP2', name: 'Ziihera mechanism perception',   moRef: 'MO2', kiq: 'How are HER2+ GEC and BTC oncologists perceiving zanidatamab bispecific data vs trastuzumab deruxtecan — and what additional evidence do they need?',     kits: ['Congress debrief', 'KOL advisory board', 'Publication review'] },
  { id: 'LP3', name: 'Pediatric DMG evidence gaps',    moRef: 'MO3', kiq: 'What clinical questions remain unanswered for pediatric and adolescent H3 K27M DMG patients — and are those gaps limiting prescriber confidence?',          kits: ['Pediatric oncology advisory board', 'Publication gap analysis'] },
  { id: 'LP4', name: 'H3 K27M testing barriers',      moRef: 'MO4', kiq: 'Where are community oncologists encountering barriers to H3 K27M molecular testing, and how is this affecting time-to-diagnosis and treatment?',           kits: ['MSL access log', 'Pathology network survey'] },
  { id: 'LP5', name: 'Access & payer landscape',       moRef: 'MO5', kiq: 'Which payer segments are creating coverage barriers for Modeyso, and what evidence do they require for favorable formulary placement?',                    kits: ['Payer landscape report', 'HEOR summary'] },
];
