...
export const SYSTEM_PROMPT_CTX = {
  ...
  dataSourcesSummary:
    'KIT scorecards, PubMed publications, ClinicalTrials.gov data, KOL profiles, social media signal monitoring (X, LinkedIn, ResearchGate, patient advocacy communities), KOL public-private alignment scoring, share-of-voice analytics, competitive landscape analysis, strategic imperatives, pipeline intelligence, market access data, congress ingestion intelligence, and sentiment trend analytics.',
};
